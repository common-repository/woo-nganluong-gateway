<?php
	 ...
	 *
	 * Xin cám ơn DUCLM - 0948389111, Ngân lượng, WooCommerce, Wordpress
	 *
	 */
	class WC_Gateway_NganLuong extends WC_Payment_Gateway {
        ...
        // Mã merchant site code - ID Connection
        private $merchant_site_code;
        // Secure password - Mật khẩu từ ngân lượng 32 ký tự md5
        private $secure_pass;
        // Debug parameters
